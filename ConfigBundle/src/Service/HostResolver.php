...
class HostResolver
{
    // Both record types are asked for in one call: a host served over IPv6 only - Infomaniak's shared hosting is - has no A record whatsoever, and gethostbyname() would report it as not existing at all. Errors are silenced rather than raised, an unresolvable name being the very answer wanted here
