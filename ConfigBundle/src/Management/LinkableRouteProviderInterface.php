...
{
    // The routes this bundle offers as a menu target, [] if none - keys, per-row entries, 'picker_label' and 'locales' all described in the readme, which the class header above points at
    /** @return array<string, array{label: string, translation_domain: string|false, route?: string, params?: array<string, string|int>, picker_label?: string, locales?: list<string>}> */
