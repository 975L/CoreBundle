...
interface MenuProviderInterface
{
     ...
     *
     * @return array<string, array{controller: class-string, label: string, translation_domain: string, icon: string, action?: string, role?: string, tier?: 'essential'|'advanced', description?: string}> slug => menu item
     */
