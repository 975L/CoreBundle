...
class CookieNonceGeneratorRegistrationTest extends TestCase
{
    ...
    public function testMainServicesFileDoesNotRegisterIt(): void
    {
        ...
        $this->assertArrayNotHasKey(CookieNonceGenerator::class, $services);
    }
    ...
    {
        $definition = Yaml::parseFile(self::CONFIG_DIR . '/services_nelmio.yaml')['services'][CookieNonceGenerator::class];
