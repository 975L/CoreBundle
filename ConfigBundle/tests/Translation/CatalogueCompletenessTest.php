...
// Adding a language to a c975L site is adding its translation file and nothing else - which only holds while every
// file of a domain says the very same things (see CatalogueCompletenessCase)
