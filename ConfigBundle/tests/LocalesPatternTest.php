...
// What a localised url accepts between its slashes, wherever a bundle declares one - the languages a site declares beside the one it is written in
class LocalesPatternTest extends TestCase
{
    ...
    private function pattern(array $enabledLocales, string $defaultLocale): string
    {
        ...
        $file = \dirname(__DIR__) . '/src/c975LConfigBundle.php';
        ...
        new c975LConfigBundle()->loadExtension([], new ContainerConfigurator($builder, $loader, $instanceof, $file, $file), $builder);

        return (string) $builder->getParameter('c975l_config.locales_pattern');
    }
