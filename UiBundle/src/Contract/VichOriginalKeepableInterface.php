...
// Marks an entity whose untouched upload is copied aside before VichImageResizeListener overwrites it in place with its own downscaled webp conversion. Unlike VichPrivateFileInterface, which moves the stored file out of public/ and leaves nothing behind, this keeps both: the served derivatives stay where they are, the original joins them under a directory of the entity's choosing.
