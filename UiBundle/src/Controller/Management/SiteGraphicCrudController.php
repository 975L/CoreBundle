...
class SiteGraphicCrudController extends AbstractCrudController
{
    ...
    public function configureCrud(Crud $crud): Crud
    {
        return $crud
            ...
            ->setEntityLabelInSingular(t('label.site_graphic', [], 'ui'))
            ->setEntityLabelInPlural(t('label.site_graphics', [], 'ui'))
            ->setEntityPermission($this->configService->get('site-role-editor'))
            ->overrideTemplate('crud/index', '@c975LUi/management/site_graphic_crud_index.html.twig')
            ->overrideTemplate('crud/edit', '@c975LUi/management/site_graphic_crud_edit.html.twig')
            ->overrideTemplate('crud/new', '@c975LUi/management/site_graphic_crud_new.html.twig')
        ;
    }
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        return [
            ...
            Field::new('file')
                ...
                ->setHelp(t('label.site_graphic_file_help', [], 'ui'))
    ...
    // The singleton graphics not uploaded yet, as a list of "label + url to the pre-filled upload form" - empty once every one of them exists. Repeatable roles are left out: never missing, they are added through the plain "new" action
