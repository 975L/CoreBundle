...
// One row of the customization screen: what the client may do to a single unit of a legal model. The title and the text arrive pre-filled with the bundle's own wording, so they are edited in place rather than overridden blind - a row left as it came produces no delta at all and keeps arriving from the bundle.
