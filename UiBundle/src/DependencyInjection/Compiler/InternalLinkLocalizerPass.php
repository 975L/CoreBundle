...
class InternalLinkLocalizerPass extends AbstractProviderPass
{
    public function __construct()
    {
        parent::__construct(InternalLinkLocalizerInterface::class, InternalLinkLocalizerRegistry::class);
    }
}
