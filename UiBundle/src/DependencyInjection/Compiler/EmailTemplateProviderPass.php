...
class EmailTemplateProviderPass extends AbstractProviderPass
{
    public function __construct()
    {
        parent::__construct(EmailTemplateProviderInterface::class, EmailTemplateProviderRegistry::class);
    }
}
