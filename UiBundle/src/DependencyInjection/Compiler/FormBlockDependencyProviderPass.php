...
class FormBlockDependencyProviderPass extends AbstractProviderPass
{
    public function __construct()
    {
        parent::__construct(FormBlockDependencyProviderInterface::class, FormBlockDependencyRegistry::class);
    }
}
