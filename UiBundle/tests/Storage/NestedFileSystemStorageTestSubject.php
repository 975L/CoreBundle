...
{
    public function publicDoUpload(PropertyMappingInterface $mapping, File $file, ?string $dir, string $name): ?File
    {
        return $this->doUpload($mapping, $file, $dir, $name);
    }

    public function publicDoRemove(PropertyMappingInterface $mapping, ?string $dir, string $name): ?bool
    {
        return $this->doRemove($mapping, $dir, $name);
    }

    public function publicDoResolvePath(PropertyMappingInterface $mapping, ?string $dir, string $name, ?bool $relative = false): string
    {
