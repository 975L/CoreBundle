...
class CollectionItemStatVariantTest extends TestCase
{
    ...
    {
        $html = $this->render(['title' => 'Kalaan', 'eyebrow' => 'Seigneur', 'imageUrl' => '/uploads/kalaan.jpg']);

        $this->assertStringContainsString('eyebrow="Seigneur"', $html);
        $this->assertStringContainsString('src="/uploads/kalaan.jpg"', $html);
        $this->assertStringContainsString('alt="Kalaan"', $html);
    ...
    {
        $this->assertStringContainsString('rating="0"', $this->render(['title' => 'Kalaan', 'rating' => 0]));
        $this->assertStringNotContainsString('rating=', $this->render(['title' => 'Kalaan', 'content' => 'Text']));
    }
    ...
    {
        $html = $this->render(['title' => 'Kalaan', 'eyebrow' => 'Seigneur', 'detailUrl' => '/pages/guilde/kalaan', 'url' => 'https://example.org']);

        $this->assertStringContainsString('titleUrl="/pages/guilde/kalaan"', $html);
    }
    ...
    {
        $html = $this->render(['title' => 'Kalaan', 'eyebrow' => 'Seigneur', 'content' => "Une ligne\nUne autre"]);
    ...
    {
        $this->assertStringContainsString('class="faction-guilde"', $this->render(['title' => 'Kalaan', 'eyebrow' => 'Seigneur', 'class' => 'faction-guilde']));
    ...
    {
        $html = $this->render(['title' => 'Kalaan', 'content' => 'Text']);
