...
class FlashVariantTest extends TestCase
{
    ...
    private function renderFlashesBlock(array $flashes): string
    {
        ...
        // The guard is FlashExtensionTest's business; here the bag is always readable so the mapping is what is exercised
        $twig->addFunction(new TwigFunction('ui_can_hold_flash', static fn (): bool => true));
